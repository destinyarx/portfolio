...
const projectList: Project[] = [
    {
        ...
        link: 'https://personal-projects-seven.vercel.app/water-station-system',
        image: 'water-station'
    },
    {
        ...
        link: 'https://personal-projects-seven.vercel.app/ent-clinic',
        image: 'ent-clinic'
    },
    {
        title: 'Better Buy',
        ...
        link: 'https://personal-projects-seven.vercel.app/better-buy',
        image: 'better-buy'
      },
      {
        ...
        link: 'https://personal-projects-seven.vercel.app/customer-service-automation',
        image: 'messenger-bot'
      },
]
        ...
        <div className="min-h-[20vh] mt-20">
            ...
            <div className="flex flex-col gap-5 text-left">
                {projectList.map((project, index) => (
                    <ProjectInformation onClick={() => handleClick(project.link)} key={index} project={project}/>
                ))}
            </div>
        </div>
    )
